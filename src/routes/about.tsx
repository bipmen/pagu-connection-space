...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Pagu" },
      { name: "description", content: "Pagu is a FLINTA*-led collective in Cologne creating intentional spaces for connection." },
      { property: "og:title", content: "About Pagu" },
      { property: "og:description", content: "Building FLINTA* community beyond algorithms." },
    ],
  }),
  component: AboutPage,
});
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="px-5 lg:px-8 max-w-4xl mx-auto pt-16 pb-24">
