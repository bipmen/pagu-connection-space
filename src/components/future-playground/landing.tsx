...
/**
 * Future Playground landing sections.
 * Shared by `/` (production landing) and `/future-playground` (preview route).
 * Wrap with `theme-future` so styles stay scoped.
 */
export function FuturePlaygroundLanding() {
  return (
  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-gradient-hero">
      ...
      <div className="relative max-w-7xl mx-auto px-5 lg:px-8 pt-20 pb-28 md:pt-32 md:pb-36">
        <div className="flex items-center gap-3 mb-8 fp-rise flex-wrap">
        ...
        >
          <Link to={s.ctaTo} className="fp-cta">
        ...
        <div className="mt-14 flex items-center gap-4">
          <button
            onClick={() => setSlide((v) => (v - 1 + HERO_SLIDES.length) % HERO_SLIDES.length)}
          ...
          <button
            onClick={() => setSlide((v) => (v + 1) % HERO_SLIDES.length)}
            className="h-11 w-11 rounded-full border border-border/60 grid place-items-center hover:bg-card"
  ...
  return (
    <section className="relative max-w-7xl mx-auto px-5 lg:px-8 py-24 md:py-32">
      ...
      <div className="mt-16 fp-card p-8 md:p-12 flex flex-col md:flex-row items-start md:items-center gap-6 bg-gradient-purple text-primary-foreground">
        ...
        <Link to="/register" className="fp-cta md:ml-auto">
    ...
    <section className="relative max-w-7xl mx-auto px-5 lg:px-8 py-24 md:py-32">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="mb-6">
            A living map of <span className="fp-italic text-gold">where we are</span>.
          </h2>
          <p className="text-muted-foreground text-lg max-w-md mb-8">
            Events, Safe Spaces, and people you can meet right now — clustered as an ecosystem, not a list.
          </p>
          <Link to="/community-map" className="fp-cta">
          ...
          {EVENTS.map((e) => (
            <article key={e.title} className="fp-card overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <Link
                  to="/community-events"
                  className="mt-6 inline-flex items-center gap-2 text-gold font-medium text-sm self-start"
                >
